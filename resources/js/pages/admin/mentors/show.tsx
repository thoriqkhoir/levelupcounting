        ...
        router.post(
            ...
            { amount },
            {
                onSuccess: () => {
                    ...
                    setWithdrawAmount('');
                    toast.success('Permintaan penarikan berhasil diproses.');
                },
                onError: (errors: any) => {
                    toast.error(errors.message || 'Gagal memproses penarikan.');
                },
                onFinish: () => {
                                ...
                                {stats.available_commission > 0 && (
                                    <>
                                        <Dialog open={withdrawOpen} onOpenChange={setWithdrawOpen}>
                                            ...
                                            <DialogContent>
                                                <DialogHeader>
                                                    <DialogTitle>Tarik Komisi Mentor</DialogTitle>
                                                    <DialogDescription>
                                                        Tarik saldo komisi yang tersedia untuk mentor {mentor.name}.
                                                    </DialogDescription>
                                                </DialogHeader>
