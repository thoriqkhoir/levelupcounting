...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Tambah Paket Bundling Baru',
...
export default function CreateBundle({ courses, bootcamps, webinars }: CreateProps) {
    ...
    function onSubmit(values: FormValues) {
        router.post(route('bundles.store'), values, { forceFormData: true });
    }

    return (
        <AdminLayout breadcrumbs={breadcrumbs}>
            <Head title="Tambah Paket Bundling Baru" />
            <div className="px-4 py-4 md:px-6">
                <h1 className="text-2xl font-semibold">Tambah Paket Bundling Baru</h1>
                <p className="text-muted-foreground mb-6 max-w-2xl text-sm">
                    Buat paket bundling yang berisi kombinasi kelas online, bootcamp, dan webinar dengan harga spesial.
                </p>
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="grid grid-cols-1 items-start gap-6 lg:grid-cols-2">
                        <div className="space-y-6 rounded-lg border p-4">
                            <div className="flex items-center gap-2">
                                <Package size={16} />
                                <h3 className="font-medium">Informasi Paket Bundling</h3>
                            </div>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input placeholder="Masukkan judul bundle" {...field} autoComplete="off" />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                                                    ...
                                                    <PopoverContent className="w-auto overflow-hidden p-0" align="start">
                                                        <CalendarComponent
                                                            ...
                                                            onSelect={(date) => {
                                                                ...
                                                                setIsDeadlineAutoSet(false); // Manual override
                                                            }}
                                                        />
                                                    </PopoverContent>
                                                </Popover>
                        ...
                        <Button type="submit" className="hover:cursor-pointer lg:col-span-2" disabled={form.formState.isSubmitting}>
                            {form.formState.isSubmitting ? 'Menyimpan...' : 'Simpan Draft Bundle'}
                        </Button>
                    </form>
                </Form>
            </div>
