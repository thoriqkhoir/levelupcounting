...
export function DataTable<TData, TValue>({ columns, data, programId }: DataTableProps<TData, TValue>) {
    ...
    const handleExportToExcel = () => {
        ...
        params.append('product_type', 'certification_program');

        if (programId) {
            params.append('certification_program_id', programId);
        }
