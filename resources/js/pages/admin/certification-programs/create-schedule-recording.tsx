...
export default function AddScheduleRecordingDialog({ programId, scheduleId, currentRecordingUrl, type = 'schedule' }: AddScheduleRecordingDialogProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const routeName = type === 'socialization'
            ? 'certification-programs.add-socialization-recording'
            : 'certification-programs.add-recording';

        router.post(
            route(routeName, { program: programId, schedule: scheduleId }),
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[600px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Masukkan link YouTube untuk rekaman sesi program sertifikasi ini. Link akan otomatis ditampilkan untuk peserta yang terdaftar.
                    </DialogDescription>
                </DialogHeader>
