...
interface Statistics {
    overview: {
        ...
        published_bootcamps: number;
        draft_bootcamps: number;
        archived_bootcamps: number;
    };
    pricing: {
        free_bootcamps: number;
        paid_bootcamps: number;
    };
    completion: {
        completed: number;
        ongoing: number;
                ...
                <div className="mb-6 space-y-4">
                        ...
                        <div className="dark:to-background rounded-lg border bg-gradient-to-br from-blue-50 to-white p-4 shadow-sm dark:from-blue-950/20">
                            <div className="flex items-center justify-between">
                                <div className="flex-1">
                                    <p className="text-muted-foreground text-xs font-medium">Total Bootcamp</p>
                                    <h3 className="mt-1 text-xl font-bold">{statistics.overview.total_bootcamps}</h3>
                    ...
                    <div className="md:hidden">
                        ...
                        {showMoreStats && (
                            <div className="mt-4 space-y-3">
                                ...
                                <div className="rounded-lg border p-3 text-sm">
                                    ...
                                    <div className="space-y-1">
                                        <div className="flex items-center justify-between">
                                            ...
                                            <span className="text-xs font-medium text-purple-600">{statistics.pricing.paid_bootcamps}</span>
                                        </div>
                                        <div className="flex items-center justify-between">
                                            <span className="text-muted-foreground text-xs">Gratis</span>
                                            <span className="text-xs font-medium text-green-600">{statistics.pricing.free_bootcamps}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                {/* Status Breakdown */}
                                <div className="rounded-lg border p-3 text-sm">
                                    <h4 className="mb-2 font-semibold">Status Bootcamp</h4>
                                    <div className="space-y-1">
                                        <div className="flex items-center justify-between">
                                            <span className="text-muted-foreground text-xs">Published</span>
                                            <span className="text-xs font-medium text-green-600">{statistics.overview.published_bootcamps}</span>
                                        </div>
                                        <div className="flex items-center justify-between">
                                            <span className="text-muted-foreground text-xs">Draft</span>
                                            <span className="text-xs font-medium text-gray-600">{statistics.overview.draft_bootcamps}</span>
                                        </div>
                                        <div className="flex items-center justify-between">
                                            <span className="text-muted-foreground text-xs">Archived</span>
                                            <span className="text-xs font-medium text-gray-600">{statistics.overview.archived_bootcamps}</span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className={`hidden gap-4 md:grid md:grid-cols-2 ${isStaff ? 'lg:grid-cols-3' : 'lg:grid-cols-4'}`}>
                        <div className="dark:to-background rounded-lg border bg-gradient-to-br from-blue-50 to-white p-4 shadow-sm dark:from-blue-950/20">
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-muted-foreground text-sm font-medium">Total Bootcamp</p>
                                    <h3 className="mt-2 text-2xl font-bold">{statistics.overview.total_bootcamps}</h3>
                                </div>
                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <h3 className="mt-2 text-2xl font-bold text-green-600 dark:text-green-400">
                                        {statistics.overview.published_bootcamps}
                                    </h3>
                                    <p className="mt-1 text-xs text-gray-600 dark:text-gray-400">{statistics.overview.draft_bootcamps} draft</p>
                                </div>
