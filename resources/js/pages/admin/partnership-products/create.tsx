...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    },
    {
        ...
        href: route('partnership-products.create'),
    },
];
...
export default function CreatePartnershipProduct({ categories }: { categories: { id: string; name: string }[] }) {
    ...
    return (
        <AdminLayout breadcrumbs={breadcrumbs}>
            <Head title="Tambah Produk Partnership Baru" />
            <div className="px-4 py-4 md:px-6">
                <h1 className="text-2xl font-semibold">Tambah Produk Partnership Baru</h1>
                <p className="text-muted-foreground mb-6 max-w-2xl text-sm">
                    Tambahkan produk kerjasama dengan partner eksternal. Produk ini akan mengarahkan pengguna ke link pendaftaran eksternal.
                </p>
                <Form {...form}>
