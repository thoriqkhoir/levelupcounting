...
import { columns, type WebinarRating } from './columns-ratings';
import { DataTable } from './data-table.ratings';

interface WebinarRatingComponentProps {
    ratings: WebinarRating[];
    averageRating?: number;
}

export default function WebinarRatingComponent({ ratings, averageRating = 0 }: WebinarRatingComponentProps) {
    return (
                ...
                <div className="flex flex-col items-center justify-center gap-4 py-12">
                    ...
                    <div className="text-center">
                        ...
                        <p className="mt-1 text-xs text-gray-400">
                            Rating akan muncul setelah peserta menyelesaikan webinar dan memberikan penilaian.
                        </p>
                    </div>
                </div>
            )}
