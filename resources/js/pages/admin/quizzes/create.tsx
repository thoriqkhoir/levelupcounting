...
export default function CreateQuestionPage({ course, quiz }: CreateQuestionPageProps) {
    const questionInput = useRef<HTMLTextAreaElement>(null);
    const questionImageInputRef = useRef<HTMLInputElement>(null);
    const optionImageRefs = useRef<{ [key: number]: HTMLInputElement | null }>({});

    const [options, setOptions] = useState([
        { option_text: '', option_image: null as File | null, option_image_preview: null as string | null, is_correct: false },
        { option_text: '', option_image: null as File | null, option_image_preview: null as string | null, is_correct: false },
    ]);
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        explanation: '',
        quiz_id: quiz.id,
        options: options as { option_text: string; option_image: File | null; is_correct: boolean }[],
    });
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        },
        {
            ...
            href: route('questions.create', { course: course.id, quiz: quiz.id }),
        },
    ];
            ...
            <div className="px-4 py-4 md:px-6">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Buat pertanyaan baru untuk quiz "{quiz.title}"</CardDescription>
                    </CardHeader>
                    <CardContent>
                                ...
                                <Select
                                    ...
                                    onValueChange={(val) => {
                                        ...
                                        if (newType === 'true_false') {
                                            updateOptions([
                                                { option_text: 'Benar', option_image: null, option_image_preview: null, is_correct: false },
                                                { option_text: 'Salah', option_image: null, option_image_preview: null, is_correct: false },
                                            ]);
                                        } else {
                                            updateOptions([
                                                { option_text: '', option_image: null, option_image_preview: null, is_correct: false },
                                                { option_text: '', option_image: null, option_image_preview: null, is_correct: false },
                                            ]);
                                        }
                                    }}
