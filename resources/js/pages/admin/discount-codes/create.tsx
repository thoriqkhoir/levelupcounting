...
export default function CreateDiscountCode({ products }: CreateDiscountCodeProps) {
    ...
    function onSubmit(values: FormData) {
        ...
        router.post(route('discount-codes.store'), formData);
    }

    return (
        <AdminLayout breadcrumbs={breadcrumbs}>
            <Head title="Tambah Kode Diskon" />

            <div className="px-4 py-4 md:px-6">
                <h1 className="text-2xl font-semibold">Tambah Kode Diskon</h1>
                <p className="text-muted-foreground mb-6 max-w-2xl text-sm">
                    Silakan isi form di bawah ini untuk membuat kode diskon baru. Pastikan semua informasi yang diperlukan telah diisi dengan benar.
                </p>
