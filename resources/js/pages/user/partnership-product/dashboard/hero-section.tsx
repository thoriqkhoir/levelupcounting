...
const badges = [
    { icon: CheckCircle, label: 'Partner Industri Terpercaya', color: 'text-emerald-600', bg: 'bg-emerald-50 dark:bg-emerald-900/30', delay: 0.55 },
    { icon: Award, label: 'Sertifikat Profesional', color: 'text-primary', bg: 'bg-primary/5 dark:bg-primary/10', delay: 0.7 },
    ...
    return (
        <section className="relative overflow-hidden py-20 text-foreground">
            <div className="relative z-10 mx-auto max-w-7xl px-4">
                ...
                >
                    Tingkatkan kompetensi dan buka peluang karir lebih luas dengan program sertifikasi yang dirancang khusus bersama partner industri terkemuka.
                </motion.p>
