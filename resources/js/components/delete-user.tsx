        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4 rounded-lg border border-red-100 bg-red-50 p-4 dark:border-red-200/10 dark:bg-red-700/10">
                <div className="relative space-y-0.5 text-red-600 dark:text-red-100">
                    ...
                    <p className="text-sm">Silakan lanjutkan dengan hati-hati, ini tidak dapat dibatalkan.</p>
                </div>
                ...
                <Dialog>
                    ...
                    <DialogContent>
                        ...
                        <DialogDescription>
                            Setelah akun Anda dihapus, semua sumber daya dan data yang terkait juga akan dihapus secara permanen. Silakan masukkan
